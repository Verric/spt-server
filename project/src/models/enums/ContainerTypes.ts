...
export type CommonContainers = (typeof CommonContainers)[keyof typeof CommonContainers];

export const SecuredContainers = {
...
export type SecuredContainers = (typeof SecuredContainers)[keyof typeof SecuredContainers];
