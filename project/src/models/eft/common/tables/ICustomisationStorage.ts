...
export const CustomisationType = {
    SUITE: "suite",
    DOG_TAG: "dogTag",
    HEAD: "head",
    VOICE: "voice",
...
export type CustomisationType = (typeof CustomisationType)[keyof typeof CustomisationType];

export const CustomisationTypeId = {
...
export type CustomisationTypeId = (typeof CustomisationTypeId)[keyof typeof CustomisationTypeId];

export const CustomisationSource = {
    QUEST: "quest",
    PRESTIGE: "prestige",
...
export type CustomisationSource = (typeof CustomisationSource)[keyof typeof CustomisationSource];
